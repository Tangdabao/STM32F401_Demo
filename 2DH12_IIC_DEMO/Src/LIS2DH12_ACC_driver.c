...
static uint8_t Sensor_IO_Read(void *handle, uint8_t ReadAddr, uint8_t *pBuffer, uint16_t Size )
{
    ...
    status = HAL_I2C_Mem_Read( handle, LIS2DH12_ACC_I2C_ADDRESS_LOW, ( uint16_t )ReadAddr, I2C_MEMADD_SIZE_8BIT, pBuffer, Size,
...
static uint8_t Sensor_IO_Write(void *handle, uint8_t WriteAddr, uint8_t *pBuffer, uint16_t Size )
{
    ...
    status = HAL_I2C_Mem_Write( handle, LIS2DH12_ACC_I2C_ADDRESS_LOW, ( uint16_t )WriteAddr, I2C_MEMADD_SIZE_8BIT, pBuffer, Size,
                                NUCLEO_I2C_TIMEOUT_MAX );
